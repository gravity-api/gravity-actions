...
* TEST SCENARIO (Rhino)
* [test-id] 0079
* [test-scenario] - Condition, Count, Not Match, XPath
* 
* [test-actions]
* 1. navigate to {https://gravitymvctestapplication.azurewebsites.net/student}
* 2. condition {{$ --count --not_match:\d{2}}} on {//tr[./td[@id]]}
...
namespace Gravity.IntegrationTests.Cases.UiCommon.ConditionScenarios
{
    public class C0079 : TestCase
    {
        ...
        {
            // setup
            var condition = (bool)environment.TestParams["negative"] ? "\\d{1}" : "\\d{2}";
            ...
            return new List<ActionRule>()
            {
                new ActionRule
                {
                    ...
                    Argument = "{{$ --count --not_match:" + condition + "}}",
                    OnElement = "//tr[./td[@id]]",
