...
namespace Gravity.IntegrationTests.Suites.UiCommon
{
    ...
    public class ExecuteScriptTests
    {
        ...
        public void T0138P(Context environment)
        {
            ...
            // execute
            var actual = new C0138().AddEnvironments(environment).Invoke();
        ...
        public void T0139P(Context environment)
        {
            ...
            // execute
            var actual = new C0139().AddEnvironments(environment).Invoke();
        ...
        public void T0140P(Context environment)
        {
            ...
            // execute
            var actual = new C0140().AddEnvironments(environment).Invoke();
        ...
        public void T0141P(Context environment)
        {
            ...
            // execute
            var actual = new C0141().AddEnvironments(environment).Invoke();
