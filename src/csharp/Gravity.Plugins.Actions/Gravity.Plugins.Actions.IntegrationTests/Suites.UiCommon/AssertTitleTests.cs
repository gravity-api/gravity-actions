...
namespace Gravity.IntegrationTests.Suites.UiCommon
{
    ...
    public class AssertTitleTests
    {
        ...
        public void T0037P(Context environment)
        {
            ...
            // execute
            var actual = new C0037().AddEnvironments(environment).Invoke();
        ...
        public void T0038P(Context environment)
        {
            ...
            // execute
            var actual = new C0038().AddEnvironments(environment).Invoke();
        ...
        public void T0039P(Context environment)
        {
            ...
            // execute
            var actual = new C0039().AddEnvironments(environment).Invoke();
        ...
        public void T0040P(Context environment)
        {
            ...
            // execute
            var actual = new C0040().AddEnvironments(environment).Invoke();
        ...
        public void T0041P(Context environment)
        {
            ...
            // execute
            var actual = new C0041().AddEnvironments(environment).Invoke();
        ...
        public void T0042P(Context environment)
        {
            ...
            // execute
            var actual = new C0042().AddEnvironments(environment).Invoke();
        ...
        public void T0043P(Context environment)
        {
            ...
            // execute
            var actual = new C0043().AddEnvironments(environment).Invoke();
        ...
        public void T0044P(Context environment)
        {
            ...
            // execute
            var actual = new C0044().AddEnvironments(environment).Invoke();
