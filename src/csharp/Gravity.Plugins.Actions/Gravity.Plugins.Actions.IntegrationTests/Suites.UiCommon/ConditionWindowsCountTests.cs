...
namespace Gravity.IntegrationTests.Suites.UiCommon
{
    ...
    public class ConditionWindowsCountTests
    {
        ...
        public void T0120P(Context environment)
        {
            ...
            // execute
            var actual = new C0120().AddEnvironments(environment).Invoke();
        ...
        public void T0121P(Context environment)
        {
            ...
            // execute
            var actual = new C0121().AddEnvironments(environment).Invoke();
        ...
        public void T0122P(Context environment)
        {
            ...
            // execute
            var actual = new C0122().AddEnvironments(environment).Invoke();
        ...
        public void T0123P(Context environment)
        {
            ...
            // execute
            var actual = new C0123().AddEnvironments(environment).Invoke();
        ...
        public void T0124P(Context environment)
        {
            ...
            // execute
            var actual = new C0124().AddEnvironments(environment).Invoke();
        ...
        public void T0125P(Context environment)
        {
            ...
            // execute
            var actual = new C0125().AddEnvironments(environment).Invoke();
        ...
        public void T0126P(Context environment)
        {
            ...
            // execute
            var actual = new C0126().AddEnvironments(environment).Invoke();
        ...
        public void T0127P(Context environment)
        {
            ...
            // execute
            var actual = new C0127().AddEnvironments(environment).Invoke();
