...
* TEST SCENARIO (Rhino)
* [test-id] 0077
* [test-scenario] - Condition, Count, Not Equal, XPath
* 
* [test-actions]
* 1. navigate to {https://gravitymvctestapplication.azurewebsites.net/student}
* 2. condition {{$ --count --ne:1}} on {//tr[./td[@id]]}
...
namespace Gravity.IntegrationTests.Cases.UiCommon.ConditionScenarios
{
    public class C0077 : TestCase
    {
        ...
        {
            // setup
            var condition = (bool)environment.TestParams["negative"] ? "3" : "1";
