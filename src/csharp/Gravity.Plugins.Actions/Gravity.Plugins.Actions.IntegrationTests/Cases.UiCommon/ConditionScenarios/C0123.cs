...
* TEST SCENARIO (Rhino)
* [test-id] 0123
* [test-scenario] - Condition, Windows Count, Not Match
* 
* [test-actions]
* 1. navigate to {https://gravitymvctestapplication.azurewebsites.net/uicontrols}
* 2. condition {{$ --windows_count --not_match:^0$}}
        ...
        public override IEnumerable<ActionRule> OnActions(Context environment)
        {
            ...
            return new List<ActionRule>()
            {
                new ActionRule
                {
                    ...
                    Argument = "{{$ --windows_count --not_match:" + condition + "}}",
