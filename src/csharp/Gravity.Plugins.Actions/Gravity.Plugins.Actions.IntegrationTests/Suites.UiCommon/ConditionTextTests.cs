...
namespace Gravity.IntegrationTests.Suites.UiCommon
{
    ...
    public class ConditionTextTests
    {
        ...
        public void T0095P(Context environment)
        {
            ...
            // execute
            var actual = new C0095().AddEnvironments(environment).Invoke();
        ...
        public void T0096P(Context environment)
        {
            ...
            // execute
            var actual = new C0096().AddEnvironments(environment).Invoke();
        ...
        public void T0097P(Context environment)
        {
            ...
            // execute
            var actual = new C0097().AddEnvironments(environment).Invoke();
        ...
        public void T0098P(Context environment)
        {
            ...
            // execute
            var actual = new C0098().AddEnvironments(environment).Invoke();
        ...
        public void T0099P(Context environment)
        {
            ...
            // execute
            var actual = new C0099().AddEnvironments(environment).Invoke();
        ...
        public void T0100P(Context environment)
        {
            ...
            // execute
            var actual = new C0100().AddEnvironments(environment).Invoke();
        ...
        public void T0101P(Context environment)
        {
            ...
            // execute
            var actual = new C0101().AddEnvironments(environment).Invoke();
        ...
        public void T0102P(Context environment)
        {
            ...
            // execute
            var actual = new C0102().AddEnvironments(environment).Invoke();
