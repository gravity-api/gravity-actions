...
* TEST SCENARIO (Rhino)
* [test-id] 0097
* [test-scenario] - Condition, Text, Match, XPath
* 
* [test-actions]
* 1. navigate to {https://gravitymvctestapplication.azurewebsites.net/student}
* 2. condition {{$ --text --match:^Students$}} on {//h2}
...
namespace Gravity.Plugins.Actions.IntegrationTests.Cases.UiCommon.ConditionScenarios
{
    public class C0097 : TestCase
    {
        ...
        {
            var condition = (bool)environment.TestParams["negative"] ? "^Not Students$" : "^Students$";
