...
namespace Gravity.IntegrationTests.Suites.UiCommon
{
    ...
    public class AssertAttributeTests
    {
        ...
        public void T0002P(Context environment)
        {
            ...
            // execute
            var actual = new C0002().AddEnvironments(environment).Invoke();
        ...
        public void T0003P(Context environment)
        {
            ...
            // execute
            var actual = new C0003().AddEnvironments(environment).Invoke();
        ...
        public void T0004P(Context environment)
        {
            ...
            // execute
            var actual = new C0004().AddEnvironments(environment).Invoke();
        ...
        public void T0005P(Context environment)
        {
            ...
            // execute
            var actual = new C0005().AddEnvironments(environment).Invoke();
        ...
        public void T0006P(Context environment)
        {
            ...
            // execute
            var actual = new C0006().AddEnvironments(environment).Invoke();
        ...
        public void T0007P(Context environment)
        {
            ...
            // execute
            var actual = new C0007().AddEnvironments(environment).Invoke();
        ...
        public void T0008P(Context environment)
        {
            ...
            // execute
            var actual = new C0008().AddEnvironments(environment).Invoke();
        ...
        public void T0009P(Context environment)
        {
            ...
            // execute
            var actual = new C0009().AddEnvironments(environment).Invoke();
