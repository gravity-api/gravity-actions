...
* TEST SCENARIO (Rhino)
* [test-id] 0078
* [test-scenario] - Condition, Count, Match, XPath
* 
* [test-actions]
* 1. navigate to {https://gravitymvctestapplication.azurewebsites.net/student}
* 2. condition {{$ --count --match:\d{1}}} on {//tr[./td[@id]]}
...
namespace Gravity.IntegrationTests.Cases.UiCommon.ConditionScenarios
{
    public class C0078 : TestCase
    {
        ...
        {
            // setup
            var condition = (bool)environment.TestParams["negative"] ? "\\d{2}" : "\\d{1}";
            ...
            return new List<ActionRule>()
            {
                new ActionRule
                {
                    ...
                    Argument = "{{$ --count --match:" + condition + "}}",
                    OnElement = "//tr[./td[@id]]",
